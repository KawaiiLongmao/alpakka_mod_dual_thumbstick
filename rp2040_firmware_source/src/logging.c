...
void logging_set_level(LogLevel level) { logging_level = level; }

bool logging_get_level() { return logging_level; }

void logging_set_onloop(bool value) { logging_onloop = value; }

bool logging_get_onloop() { return logging_onloop; }
