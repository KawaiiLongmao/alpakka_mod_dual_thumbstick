...
// #define ADDR_WEBUSB_IN 0x85
// #define ADDR_WEBUSB_OUT 0x05
...
#define MS_OS_COMPATIDS_XUSB(xusb_itf)             \
  xusb_itf,               /* Interface index */    \
      0x01,               /* Reserved */           \
      'X', 'U', 'S', 'B', /* Compat ID */          \
      '1', '0', 0x00, 0x00,                        \
      0x00, 0x00, 0x00, 0x00, /* Sub-compat ID. */ \
...
#define MS_OS_COMPATIDS_ALL   \
  MS_OS_COMPATIDS(64, 2),     \
      ...
      MS_OS_COMPATIDS_XUSB(ITF_XINPUT)
...
#define MS_OS_PROPERTIES                                                           \
  0x8E, 0x00, 0x00, 0x00,                  /* Length */                            \
      ...
      0x28, 0x00, /* Property name size */ /* Property name */                     \
      'D', 0, 'e', 0, 'v', 0, 'i', 0, 'c', 0, 'e', 0, 'I', 0, 'n', 0,              \
      't', 0, 'e', 0, 'r', 0, 'f', 0, 'a', 0, 'c', 0, 'e', 0, 'G', 0,              \
      'U', 0, 'I', 0, 'D', 0, 0, 0, /* Data size */                                \
      0x4E, 0x00, 0x00, 0x00,       /* Data */                                     \
...
#define TUD_HID_REPORT_DESC_MOUSE_CUSTOM(...)                                                    \
  HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP),                                                        \
      ...
      HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP), /* X, Y position [-32767, 32767] */                \
...
#define TUD_HID_REPORT_DESC_GAMEPAD_CUSTOM(...)                            \
  HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP),                                  \
      ...
      HID_COLLECTION(HID_COLLECTION_APPLICATION), /* Report ID */          \
      __VA_ARGS__                                 /* Axis */               \
      HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP),                              \
      HID_USAGE(HID_USAGE_DESKTOP_X),                                      \
      HID_USAGE(HID_USAGE_DESKTOP_Y),                                      \
      ...
      HID_REPORT_SIZE(16) /* CHANGED */,                                   \
      HID_INPUT(HID_DATA | HID_VARIABLE | HID_ABSOLUTE), /* Button mask */ \
      HID_USAGE_PAGE(HID_USAGE_PAGE_BUTTON),                               \
      HID_USAGE_MIN(1),                                                    \
      HID_USAGE_MAX(32),                                                   \
      HID_LOGICAL_MIN(0),                                                  \
