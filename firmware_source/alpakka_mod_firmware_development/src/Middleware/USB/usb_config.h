...
#define CFG_USBD_BASE ESP_USB_FS0_BASE
#define CFG_USBH_BASE ESP_USB_FS0_BASE
#define CONFIG_USBDEV_MAX_BUS 1
#define CONFIG_USBHOST_MAX_BUS 1
#elif CONFIG_IDF_TARGET_ESP32P4
#define ESP_USB_HS0_BASE 0x50000000
#define ESP_USB_FS0_BASE 0x50040000
#define CFG_USBD_BASE ESP_USB_HS0_BASE
#define CFG_USBH_BASE ESP_USB_HS0_BASE
#define CONFIG_USBDEV_MAX_BUS 2
#define CONFIG_USBHOST_MAX_BUS 2
#define CONFIG_USB_HS
#else
#define CFG_USBD_BASE (NULL)
#define CFG_USBH_BASE (NULL)
#endif
